...
import { LeftGraphRightTextSlideComponent } from '../left-graph-right-text-slide/left-graph-right-text-slide.component';
import { BarChartComponent, GaugeChartComponent, NgGraphComponent, TreemapChartComponent, ZoomableTreemapChartComponent } from '@labdat/charts';
import { PieGridChartComponent, NumberCardComponent, SunburstChartComponent, HierarchicalEdgeBundlingComponent } from '@labdat/charts';
import { AdvancedPieChartComponent, ForceDirectedGraphComponent, LineChartComponent} from '@labdat/charts';
import { DendogramComponent, PieChartComponent, BubbleChartComponent, WordCloudComponent, AreaChartComponent } from '@labdat/charts';
...
describe('RightGraphLeftTextSlideComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ RightGraphLeftTextSlideComponent, LeftGraphRightTextSlideComponent, FullScreenGraphSlideComponent, BarChartComponent,
        LineChartComponent,
