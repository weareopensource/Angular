...
# ngrx
Several libraries are providing a store solution for angular, but [ngrx](https://github.com/ngrx/platform) is by far the one that is the closest to the Angular. It's build upon rxjs that is a fondamental peace of Angular.
